...
export default function () {
  const url = 'http://localhost:5139/Inventory/create';
  const payload = 'Name=HAMBURGUESA+k6&Description=Descripcion K6&ShowStore=true&Price=5.90&Stock=10.0&Discount=0.0&CategoryName=HAMBURGUESA';
    const params = {
        headers: {
...
export function handleSummary(data) {
  return {
    "reports/agregar_producto.html": htmlReport(data),
  };
}