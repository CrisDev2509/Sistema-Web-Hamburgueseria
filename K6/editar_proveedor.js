...
export default function () {
  const url = 'http://localhost:5139/Supplier/Edit/1014';
  const payload = 'Name=PROVEEDOR+K6+ACTUALIZADO&RUC=1043170349&Email=proveedor%40jmeter.com';
    const params = {
        headers: {
...
export function handleSummary(data) {
  return {
    "reports/editar_proveedor.html": htmlReport(data),
  };
}